...
- Button style standard: `default` and `outline` button variants must use an `80px` border radius
- Button color standard: `default`/primary button background must be `#d52c5a` (hover `#cc0047`)
