...
// Query: *[_type == "blog" && (seoHideFromLists != true)] | order(orderRank asc) [$start...$end]{      _type,  _id,  title,  description,  "slug": select(    !defined(slug.current) => null,    slug.current match "/blog/*" => "/resources/blog/" + string::split(slug.current, "/")[-1],    slug.current match "/resources/blog/*" => "/resources/blog/" + string::split(slug.current, "/")[-1],    "/resources/blog/" + slug.current  ),  orderRank,    "categories": array::compact(categories[]->{    _id,    title  }),    image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  publishedAt,    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
...
// Query: *[_type == "blog" && defined(slug.current) && (seoHideFromLists != true)]{      _type,  _id,  title,  description,  "slug": select(    !defined(slug.current) => null,    slug.current match "/blog/*" => "/resources/blog/" + string::split(slug.current, "/")[-1],    slug.current match "/resources/blog/*" => "/resources/blog/" + string::split(slug.current, "/")[-1],    "/resources/blog/" + slug.current  ),  orderRank,    "categories": array::compact(categories[]->{    _id,    title  }),    image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  publishedAt,    authors[0]->{    _id,    name,    position,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  }  }  }
...
// Query: {  "slugPages": *[_type == "page" && defined(slug.current)]{    "slug": slug.current,    "lastModified": _updatedAt  },  "blogIndexPages": *[_type == "blogIndex" && defined(slug.current)]{    "slug": slug.current,    "lastModified": _updatedAt  },  "blogPages": *[_type == "blog" && defined(slug.current)]{    "slug": select(      slug.current match "/blog/*" => "/resources/blog/" + string::split(slug.current, "/")[-1],      slug.current match "/resources/blog/*" => "/resources/blog/" + string::split(slug.current, "/")[-1],      "/resources/blog/" + slug.current    ),    "lastModified": _updatedAt  }}
export type QuerySitemapDataResult = {
  slugPages: Array<{
    slug: string;
    lastModified: string;
  }>;
  blogIndexPages: Array<{
    slug: string;
    lastModified: string;
  }>;
  blogPages: Array<{
